...
class Enemy(pygame.sprite.Sprite):
    ...
    # No arguments from the user as ennemies will move automatically
    def update(self):
        self.rect.move_ip(-self.speed, 0)
        # Delete ennemies that are going off the screen on the left
...
# Add this new event to the queue at regular intervals
pygame.time.set_timer(ADDENEMY, 250)
# same for clouds spawning
...
# Create sprite groups to hold enemy sprites and all sprites
...
while running:
    ...
    # Fill the screen with sky color (pinky)
    screen.fill((255, 243, 255))

    # blit is short for Block transfer
    # Draw all sprites
